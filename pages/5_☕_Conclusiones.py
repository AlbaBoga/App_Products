...
if option=='Resumen de los datos':
    st.markdown("""<iframe title="productoselectronicos" width="1024" height="1060" src="https://app.fabric.microsoft.com/view?r=eyJrIjoiZjk2OWMxNmYtM2NjYy00NDgwLWI5YTItZmM1Y2RlZGQ4OWQ3IiwidCI6IjhhZWJkZGI2LTM0MTgtNDNhMS1hMjU1LWI5NjQxODZlY2M2NCIsImMiOjl9" frameborder="0" allowFullScreen="true"></iframe>""",unsafe_allow_html=True)
